...
<html lang="en">
	<head>
		...
		<link href="assets/css/green.css" rel="alternate stylesheet" title="Red color">
		<link href="assets/css/blue.css" rel="alternate stylesheet" title="Blue color">
		<link href="assets/css/red.css" rel="alternate stylesheet" title="Red color">
		<link href="assets/css/orange.css" rel="alternate stylesheet" title="Red color">
	...
	<div class="product">		
		...
		<div class="product-info text-left">
			...
			<div class="product-price">	
				<span class="price">
					Pesos. <?php echo htmlentities($row['productPrice']);?>			</span>
										     <span class="price-before-discount">Pesos. <?php echo htmlentities($row['productPriceBeforeDiscount']);?></span>
